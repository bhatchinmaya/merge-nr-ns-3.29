 ...
 *
 * For example, if you select Release 10 (or if you don't select anything, as
...
private:
  ...
  /**
   * \brief Retrieve requirements for Rel. 10
   * \return the BearerRequirementsMap for Release 10
   *
   ...
   */
  static BearerRequirementsMap * GetRequirementsRel10 ();
